            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="mt-6 bg-black/30 border border-white/10 rounded-xl p-6 md:p-8 space-y-6">
                    <div>
                        ...
                        <p className="text-white/80">Software Engineer with a Computer Science background and professional experience building high-performance C++ systems, currently based in Tokyo.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="text-white/80 leading-relaxed">
                            ...
                            <BubbleText bgClassNames="bg-blue-700" text="C++"/>, working mostly on gameplay
                            architecture, memory management, multiplayer systems, and performance.
                        </p>
                    </div>
